...
public class Utils {
    ...
    public static int getYear (String str){
        ...
        int yearCurrent = zoneDatetime.getYear();
        while (true) {
            try {
                System.out.println(str);
                Scanner sc = new Scanner(System.in);
    ...
    public static String getColor(String str) {
        ...
        do {
            ...
            Scanner sc = new Scanner(System.in);
            String tmp = sc.nextLine();
            if (!tmp.isEmpty() && (tmp.equals("blue") || tmp.equals("red") || tmp.equals("green") || tmp.equals("Blue") || tmp.equals("Red") || tmp.equals("Green"))) {
                result = tmp;
                check = false;
            } else {
                System.out.println("Enter wrong color, please re-enter (Blue/Red/Green)!");
            }
        } while (check);
        return result;
    }
    ...
    public static String getType(String str){
        ...
        do {
            ...
            if (!tmp.isEmpty() && (tmp.equals("sport") || tmp.equals("travel") || tmp.equals("common") || tmp.equals("Sport") || tmp.equals("Travel") || tmp.equals("Common"))) {
                ...
                System.out.println("Enter wrong type, please re-enter(Sport/Travel/Common)!");
            }
        } while (check);
        return result;
    }
